...
const FinishRide = (props) => {
  return (
    <div>
      ...
      <h3 className="text-2xl font-semibold mb-6 mt-3">Finish this Ride</h3>
      <div className="flex items-center justify-between mt-4 p-4 border-2 border-yellow-300 rounded-xl">
